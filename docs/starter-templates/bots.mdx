...
You can deploy a simple bot for no or low cost on a variety of platforms, such as [Heroku](https://www.heroku.com/), [Fly.io](http://fly.io/) or [Render](http://render.com/).
